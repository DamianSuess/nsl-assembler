...
namespace Nsl.Instruction
{
    ...
    public class SilentInstallInstruction : AssembleExpression
    {
        public static readonly string name = "SilentInstall";
        private readonly Expression value;
        public SilentInstallInstruction(int returns)
        {
