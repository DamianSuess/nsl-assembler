/*
 * ShowUninstDetailsInstruction.java
 */
using Java.Io;
using Java.Util;
using Nsl;
...
namespace Nsl.Instruction
{
    ...
    public class ShowUninstDetailsInstruction : AssembleExpression
    {
        public static readonly string name = "ShowUninstDetails";
        private readonly Expression value;
        public ShowUninstDetailsInstruction(int returns)
        {
