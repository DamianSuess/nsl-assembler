...
namespace Nsl.Instruction
{
    ...
    public class DirVerifyInstruction : AssembleExpression
    {
        public static readonly string name = "DirVerify";
        private readonly Expression value;
        public DirVerifyInstruction(int returns)
        {
