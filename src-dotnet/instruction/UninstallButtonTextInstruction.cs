/*
 * UninstallButtonTextInstruction.java
 */
using Java.Io;
using Java.Util;
using Nsl;
...
namespace Nsl.Instruction
{
    ...
    public class UninstallButtonTextInstruction : AssembleExpression
    {
        public static readonly string name = "UninstallButtonText";
        private readonly Expression value;
        public UninstallButtonTextInstruction(int returns)
        {
