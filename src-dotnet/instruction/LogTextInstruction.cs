...
namespace Nsl.Instruction
{
    ...
    public class LogTextInstruction : AssembleExpression
    {
        public static readonly string name = "LogText";
        private readonly Expression text;
        public LogTextInstruction(int returns)
        {
