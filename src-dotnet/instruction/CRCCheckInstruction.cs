...
namespace Nsl.Instruction
{
    ...
    public class CRCCheckInstruction : AssembleExpression
    {
        public static readonly string name = "CRCCheck";
        private readonly Expression value;
        public CRCCheckInstruction(int returns)
        {
