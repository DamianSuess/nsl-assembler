/*
 * GetDLLVersionLocalInstruction.java
 */
using Java.Io;
using Java.Util;
using Nsl;
...
namespace Nsl.Instruction
{
    ...
    public class GetDLLVersionLocalInstruction : MultipleReturnValueAssembleExpression
    {
        public static readonly string name = "GetDLLVersionLocal";
        private readonly Expression file;
        public GetDLLVersionLocalInstruction(int returns)
        {
