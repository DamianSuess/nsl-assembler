...
namespace Nsl.Instruction
{
    ...
    public class FindFirstInstruction : MultipleReturnValueAssembleExpression
    {
        public static readonly string name = "FindFirst";
        private readonly Expression file;
        public FindFirstInstruction(int returns)
        {
        ...
        public override void Assemble(List<Register> vars)
        {
            ...
            ScriptParser.WriteLine(name + " " + vars[0] + " " + vars[1] + " " + varOrFile);
