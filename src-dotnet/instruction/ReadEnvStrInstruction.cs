...
namespace Nsl.Instruction
{
    ...
    public class ReadEnvStrInstruction : AssembleExpression
    {
        public static readonly string name = "ReadEnvStr";
        private readonly Expression string;
        public ReadEnvStrInstruction(int returns)
        {
            if (PageExInfo.In())
