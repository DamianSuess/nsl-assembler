...
namespace Nsl.Instruction
{
    ...
    public class WriteRegBinInstruction : AssembleExpression
    {
        public static readonly string name = "WriteRegBin";
        private readonly Expression rootKey;
        private readonly Expression subKey;
        private readonly Expression valueName;
        private readonly Expression value;
        public WriteRegBinInstruction(int returns)
        {
