/*
 * SilentUninstallInstruction.java
 */
using Java.Io;
using Java.Util;
using Nsl;
...
namespace Nsl.Instruction
{
    ...
    public class SilentUninstallInstruction : AssembleExpression
    {
        public static readonly string name = "SilentUninstall";
        private readonly Expression value;
        public SilentUninstallInstruction(int returns)
        {
