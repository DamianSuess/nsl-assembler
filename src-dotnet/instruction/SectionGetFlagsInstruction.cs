/*
 * SectionGetFlagsInstruction.java
 */
using Java.Io;
using Java.Util;
using Nsl;
...
namespace Nsl.Instruction
{
    ...
    public class SectionGetFlagsInstruction : AssembleExpression
    {
        public static readonly string name = "SectionGetFlags";
        private readonly Expression index;
        public SectionGetFlagsInstruction(int returns)
        {
            if (PageExInfo.In())
