...
namespace Nsl.Instruction
{
    ...
    public class FileBufSizeInstruction : AssembleExpression
    {
        public static readonly string name = "FileBufSize";
        private readonly Expression value;
        public FileBufSizeInstruction(int returns)
        {
            if (returns > 0)
