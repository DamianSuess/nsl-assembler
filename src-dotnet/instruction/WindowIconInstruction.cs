...
namespace Nsl.Instruction
{
    ...
    public class WindowIconInstruction : AssembleExpression
    {
        public static readonly string name = "WindowIcon";
        private readonly Expression value;
        public WindowIconInstruction(int returns)
        {
