...
namespace Nsl.Instruction
{
    ...
    public class XPStyleInstruction : AssembleExpression
    {
        public static readonly string name = "XPStyle";
        private readonly Expression value;
        public XPStyleInstruction(int returns)
        {
