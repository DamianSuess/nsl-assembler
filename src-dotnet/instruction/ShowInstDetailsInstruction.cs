/*
 * ShowInstDetailsInstruction.java
 */
using Java.Io;
using Java.Util;
using Nsl;
...
namespace Nsl.Instruction
{
    ...
    public class ShowInstDetailsInstruction : AssembleExpression
    {
        public static readonly string name = "ShowInstDetails";
        private readonly Expression value;
        public ShowInstDetailsInstruction(int returns)
        {
